...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 32, vars: 6, consts: [[1, "height100"], ["enctype", "multipart/form-data", 3, "formGroup"], [1, "header"], [1, "label-group"], [1, "header-label"], [1, "sub-header-label"], [1, "search-outer"], [1, "search-container", "box-shadow"], ["src", "/assets/images/search.svg", "alt", "search"], ["class", "image-items ", 4, "ngFor", "ngForOf"], [1, "btn-group"], [1, "input-container"], ["type", "file", "name", "file", "id", "file", "multiple", "", "accept", "image/*", 1, "file-input", 3, "change"], ["for", "file"], ["src", "/assets/images/upload.svg"], [1, "search-btn", 3, "click"], [1, "results-count"], [1, "count-circle"], ["class", "row-info", 4, "ngIf"], [1, "results-container"], [1, "image-row", "disable-scrollbars"], ["class", "image-item box-shadow", 4, "ngFor", "ngForOf"], ["class", "image-desc box-shadow", 4, "ngIf"], [1, "image-items"], [1, "row-info"], [1, "image-item", "box-shadow"], [1, "image"], [1, "image-button"], ["type", "button", "value", "Explain", 1, "btn", "btn-primary", "btn-block", "explain-btn", 3, "click"], [1, "circles"], [1, "image-desc", "box-shadow"], [1, "desc-label"], [1, "query-image"], [1, "description"], ["id", "pieChart", 1, "chart-container", 2, "height", "500px", "width", "390px"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_20_listener() { return ctx.explainImage(); });
...
class UploadserviceService {
    ...
    runscript(formData) {
        return this.http.post('http://localhost:3000/runscript', formData, { observe: "response", responseType: 'json' });
    }
    ...
    explainImage() {
        return this.http.get('http://localhost:3000/explain', { responseType: 'json' });
    }
}
...
module.exports = __webpack_require__(/*! E:\OVGU\Sem2_Summer2020\Subjects\Project\Milestone_3_Pascal_Demo\frontend\src\main.ts */"./src/main.ts");
